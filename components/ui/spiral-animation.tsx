...
class AnimationController {
    ...
    constructor(
        ...
        this.createStars()
        this.setupTimeline(cycleDuration)
    }
    ...
    // 设置动画时间线
    private setupTimeline(cycleDuration = 15) {
        this.timeline
            .to(this, {
                time: 1,
...
interface SpiralAnimationProps {
    /** 1 = default speed; lower = slower (e.g. 0.88) */
    speed?: number
}

export function SpiralAnimation({ speed = 1 }: SpiralAnimationProps) {
    ...
    useEffect(() => {
        ...
        const cycleDuration = 15 / Math.max(0.5, speed)
        animationRef.current = new AnimationController(canvas, ctx, dpr, size, cycleDuration)
